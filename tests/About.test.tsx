...
describe("About component", () => {
  test("renders about section", () => {
    ...
    const aboutText = screen.getByText(
      /I am a software engineer\.\s+My interest lies in finding ways to make living more sustainable and less intrusive\.\s+I am having fun in React and RESTing in between\./i,
    );
