export const certificationsData = {
    ts2024: {
        ...
        image: 'https://github.com/kweeuhree/react-website/blob/master/src/assets/certifications/ts2024.png?raw=true',
        details:  [
            `Learnt how to define and implement functions with typed parameters and return types, ensuring that 
             functions behave as expected and reducing runtime errors.`,
            `Defined custom types for more complex data structures, representing objects and other data more precisely.`,
            `Narrowed down union types to more specific types at runtime, improving code accuracy and reducing potential bugs.`,
            `Used interfaces and other techniques to type objects more precisely.`,
            `Projects: Throughout the course, applied your learning in various projects like a Restaurant Recommender, 
             TypeMart, Pixel Smile, and others. These projects helped reinforce my understanding of TypeScript in real-world scenarios.`
          ]
    },
    perScholas: {
        ...
        details: [
            "Deep dive into web development with the MERN stack.",
            `I learned how to leverage the Node.js environment to utilize MongoDB for data storage and Express.js 
            for delivering data to the client while ensuring data integrity.`,
            `With a focus on component-driven development, I gained the skills to build highly scalable and 
            interactive web applications using React.js.`,
    ...
    js2024: {
        ...
        details: [
            `Learnt of the concurrency module and event loop in JavaScript.`,
            `Practiced efficient error handling.`,
            `Used JavaScript modules to define reusable logic.`,
            `Identified the ways currying and hoisting contribute to how JavaScript works under the hood.`
          ]
    },
    backendEdx2024: {
        ...
        details: [
            `Honed my skills in building robust and efficient server-side applications.`,
            `Through this course, I have learned to develop applications using asynchronous callbacks and promises, ensuring smooth and responsive user experiences.`,
            `Created REST APIs and performed CRUD operations, which are essential for building dynamic web applications.`
          ]          
    },
    async2024: {
        ...
        details: [
            `Learnt how asynchronous operations work in JavaScript using callbacks, promises, and async/await syntax.`,
            `Used async functions and the await keyword to write asynchronous code in a more synchronous style, 
    ...
    reactibm2023: {
        ...
        details: [
            `Mastered the fundamentals of React.js, learning how to break down code into reusable 
            components and effectively manage the state of elements within applications.`,
    ...
    python3: {
        ...
        details: [
            ...
            `Built Vigenere Cipher implementation upon completion. This project not only reinforced my understanding of Python 
...
export const allCertifications = {
    ...
    details: [
        `Learnt of key concepts of Next.js, such as Server-Side Rendering, Client-Side Rendering, 
        file-based routing system, dynamic routing, error handling etc.`
    ]
}, 
    express2024: {
    name: 'Learn Express',
    ...
    details: [
        `Built an Application Programming Interface (API) in JavaScript using the popular Express framework.`,
    ...
    details: [
        `This course provides a comprehensive foundation in DevOps basics and the principles of Agile development.`,
        `Gained valuable insights into DevOps methodologies, including version control, continuous integration, 
        and deployment strategies.`,
        `Learnt Agile framework, including how to effectively manage projects by writing user stories and 
        implementing Agile practices such as sprint planning, daily stand-ups, and retrospectives.`
      ]
}, 
    webDevelopment2023: {
    ...
    details: [
        `Practiced and developed hands-on skills to work with HTML, CSS, and JavaScript.`,
    ...
    details: [
        `Explored the fundamental principles and technologies that underpin cloud computing.`,
        `From the basics of HTTP protocols to advanced security measures and encryption techniques.`,
        `Gained understanding of how data is transmitted, stored, and secured in the cloud.`
      ]
},
};