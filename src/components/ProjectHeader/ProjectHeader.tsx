...
export const ProjectHeader: React.FC<Props> = ({ project, fullDisplay, toggleDisplay, index }) => {
    ...
    const titleBox = (
      ...
      const headerFlexDirection = fullDisplay ? { xs: 'column', sm: 'column', md: 'row' } : { xs: 'row', sm: 'row' };
    ...
    return (
       ...
       >
          ...
          <div className={`display-flex ${!fullDisplay && 'center-column'} ${liveLink && 'flex-gap-1vw'}`}>
              <IconWithTooltip 
